...
import { Shift } from '../../../domain/entities/shift/Shift';
...
export class OracleShiftRepository implements IShiftRepository {
  ...
  async findCurrentShift(g_mabc: string): Promise<Shift | null> {
    ...
    try {
      ...
      console.log('Chuẩn bị gọi SP W_SP_SHIFT_CHECK_CURRENT với:', { g_mabc });
      ...
      console.log('Kết quả outBinds (shift):', result.outBinds);
